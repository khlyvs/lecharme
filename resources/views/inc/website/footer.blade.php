   ...
   <footer class="site-footer py-5">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="#">Boyunbağılar</a></li>
                        <li><a href="#">Üzüklər</a></li>
                    </ul>
                </div>
                <div class="col-md-3 mb-4">
                    ...
                    <ul class="footer-contact">
                        ...
                        <li><i class="bi bi-envelope me-2"></i> info@lecharme.az</li>
                    </ul>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 footer-payments">
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" alt="Mastercard" class="payment-icon" width="40">
        </div>
    </div>
</div>
