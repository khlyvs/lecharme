...
<head>
    ...
    <link rel="shortcut icon" href="templates/default/media/logos/favicon.ico" />
    <!--begin::Fonts-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->
		<script src="https://cdn.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.min.js"></script>
		<link href="templates/default/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								<div class="menu-item">
									<a class="menu-link active" href="{{ route('dashboard.view') }}">
										...
										<span class="menu-title">Baş səhifə</span>
									</a>
								</div>
									...
									<div class="d-flex align-items-stretch flex-shrink-0">
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
												<img src="templates/default/media/user_image.jpg" alt="user_img" />
											</div>
											<!--begin::Menu-->
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															<img alt="user_img" src="templates/default/media/user_image.jpg" />
														</div>
														<!--end::Avatar-->
														<!--begin::Username-->
												...
												<div class="menu-item px-5 my-1">
													<a href="index.php?module=dashboard&page=account_settings" class="menu-link px-5">Hesab Tənzimləmələri</a>
												</div>

												<!--begin::Menu item-->
												<div class="menu-item px-5">
													<a class="menu-link px-5 logout-account"   href="logout.php"  data-bs-target="#logoutModal">Çıxış Et</a>
												</div>
												<!--end::Menu item-->

												<!-- Hesab Tənzimləmələri düyməsi -->
...
$(document).ready(function () {
    ...
    $('.logout-account').on('click', function (e) {
        e.preventDefault(); // Default link davranışını blokla
        var deleteUrl = $(this).attr('href');

        swalWithBootstrapButtons.fire({
            title: "Əminsiniz?",
            text: "Çıxı. etmək istədiyinizə əminsiniz ?",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                // Burada silmə əməliyyatı üçün yönləndirmə edilir
