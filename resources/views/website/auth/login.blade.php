...
<div id="login__page">
        <div id="login__card">
            <div id="login__header">
                <h1 id="login__logo">LeCharme</h1>
                <p id="login__subtitle">@lang('login.subtitle')</p>
            </div>
            ...
            <form id="loginForm" method="POST" action="{{ locale_route('login') }}">
                ...
                <div id="login__password-group">
                    ...
                    <div id="login__password-wrapper">
                        <input
                            type="password"
                            id="password"
                            name="password"
                ...
                <div id="login__form-options">
                    ...
                    <a href="#" id="login__forgot-password">@lang('login.forgot_password')</a>
                </div>
                   @error('error')
                    <div class="text-danger small mt-1">{{ $message }}</div>
                @enderror
            ...
            <button id="googleLogin">
                ...
                <span>@lang('login.login_google')</span>
            </button>
            </a>
            <div id="login__signup-link">
                <p>@lang('login.no_account') <a href="{{ locale_route('register') }}">@lang('login.register')</a></p>
            </div>
        </div>
    </div>
@endsection
